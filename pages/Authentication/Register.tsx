...
export default function Register() {
    ...
    return (
        <main className="auth-container">
            <form className="auth-form" onSubmit={checkPostCredentials}>
                <div className="auth-flex-row">
                    <div>
                        ...
                        <div className="auth-inputForm">
                            <img src="https://icons.veryicon.com/png/o/internet--web/aeps/full-name.png" height="20" width="20" alt="" />
                            <input
                ...
                <button className="auth-button-submit">Sign In</button>
                <p className="auth-p">
                    Already have an account?
                    <span className="auth-span" onClick={routeToLogin}>Sign in</span>
                </p>
                {/* <!-- <p className="auth-p line">Or With</p>
